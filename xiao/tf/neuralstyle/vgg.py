...
def net(data_path, input_image):
    ...
    for i, name in enumerate(layers):
        ...
        if kind == 'conv':
            ...
            # matconvnet : weight are[width,height,in_channels,out_channels]
            # tensorflow : weight are[height,width,in_channels,out_channels]
    ...
    assert len(nets) == len(layers)
    return nets, mean_pixel
